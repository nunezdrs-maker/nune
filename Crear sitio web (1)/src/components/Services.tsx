    ...
    <section id="servicios" className="py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-block bg-slate-800 text-white px-8 py-4 rounded-lg mb-8">
            <h2 className="text-3xl mb-1">Nuestros Servicios</h2>
            <p className="text-sm text-slate-300">Soluciones adaptadas a cada tipo de cliente y situación</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="border-2 border-brand-lighter rounded-lg p-6 bg-brand-lighter/30">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl">Para Particulares</h3>
            </div>
          ...
          <div className="border-2 border-blue-200 rounded-lg p-6 bg-blue-50/30">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl">Para Empresas</h3>
            </div>
            <p className="text-slate-600 text-sm mb-4">
