    ...
    <section id="quienes-somos" className="py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          {/* Left side - About */}
          <div>
            <h2 className="text-4xl mb-6">Quiénes Somos</h2>
          ...
          <div className="bg-slate-50 p-8 rounded-lg border border-slate-200">
            <h3 className="text-2xl mb-6 text-center">Nuestra Trayectoria</h3>
            
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center">
                <div className="text-4xl text-brand mb-2">+8</div>
                <div className="text-sm text-slate-600">Años trabajando con rigor y profesionalidad</div>
              </div>
              <div className="text-center">
                <div className="text-4xl text-brand mb-2">+300</div>
                <div className="text-sm text-slate-600">Inmuebles recuperados con éxito</div>
              </div>
              <div className="text-center">
                <div className="text-4xl text-brand mb-2">98%</div>
                <div className="text-sm text-slate-600">Casos resueltos bajo mediación</div>
              </div>
              <div className="text-center">
                <div className="text-4xl text-brand mb-2">+15</div>
                <div className="text-sm text-slate-600">Provincias con presencia activa</div>
              </div>
            </div>
