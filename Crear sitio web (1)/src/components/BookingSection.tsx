    ...
    <section id="reservar" className="py-20 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl mb-4">Solicitar Intervención</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="bg-slate-50 p-8 rounded-lg border border-slate-200">
              ...
              <div className="mb-6">
                ...
                <div className="bg-white px-12 py-10 rounded-lg border border-slate-200">
                  <Calendar
                    mode="single"
                    selected={date}
                    onSelect={setDate}
                    ...
                    classNames={{
                      ...
                      nav_button: "size-8 bg-transparent p-0 opacity-50 hover:opacity-100 border border-slate-300 rounded-md",
                      nav_button_previous: "absolute left-0",
                      nav_button_next: "absolute right-0",
                      table: "w-full border-collapse",
                      head_row: "flex w-full",
                      head_cell: "w-full text-center text-slate-400 py-3",
                      row: "flex w-full mt-3",
                      cell: "relative w-full p-0 text-center",
                      day: "h-12 w-12 mx-auto p-0 bg-transparent hover:bg-slate-100 rounded-full transition-colors flex items-center justify-center aria-selected:bg-brand aria-selected:text-white aria-selected:hover:bg-brand",
                    ...
                    <div className="flex gap-4 justify-center">
                      {timeSlots.map((time) => (
                        <button
                          ...
                          className={`px-12 py-4 rounded-xl border-2 transition-colors ${
                            selectedTime === time
              ...
              <Button 
                type="submit" 
                className="w-full bg-brand hover:bg-brand-dark text-white py-6"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900 text-white p-6 rounded-lg">
              <h3 className="mb-2">Atención de Urgencia</h3>
