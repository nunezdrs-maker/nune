...
export function SuccessCases() {
  ...
  const testimonials = [
    ...
    {
      text: "Después de meses de frustración con otros servicios, DESOKUPA resolvió nuestro problema en tiempo récord. Su método legal es impecable y efectivo.",
      author: "Javier M.",
      location: "Sevilla",
      rating: 5,
    ...
    {
      text: "Como propietaria de varios inmuebles, he trabajado con diferentes empresas. DESOKUPA destaca por su profesionalidad y resultados. Totalmente recomendable.",
      author: "Isabel F.",
      location: "Málaga",
      rating: 5,
    ...
    <section id="casos-exito" className="py-20 px-4 bg-slate-900 text-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl mb-4">Casos de Éxito</h2>
          <p className="text-slate-300">Testimonios reales de clientes satisfechos</p>
          <p className="text-brand-light mt-2">+300 casos resueltos con éxito</p>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto mb-12">
          <div className="bg-white text-slate-900 rounded-2xl p-8 md:p-12 shadow-2xl">
            <div className="flex justify-center mb-6">
              <Quote className="w-12 h-12 text-brand-lighter opacity-50" />
            </div>
            ...
            <p className="text-lg md:text-xl mb-6 italic text-center leading-relaxed min-h-[120px] flex items-center justify-center">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 w-12 h-12 bg-brand hover:bg-brand-dark text-white rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-110"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 w-12 h-12 bg-brand hover:bg-brand-dark text-white rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-110"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 max-w-4xl mx-auto">
          <div className="bg-slate-800 rounded-lg p-6 text-center">
            <div className="text-3xl text-brand mb-2">98%</div>
            <div className="text-sm text-slate-400">Satisfacción</div>
          </div>
          <div className="bg-slate-800 rounded-lg p-6 text-center">
            <div className="text-3xl text-brand mb-2">+300</div>
            <div className="text-sm text-slate-400">Casos resueltos</div>
          </div>
          <div className="bg-slate-800 rounded-lg p-6 text-center">
            <div className="text-3xl text-brand mb-2">4.9/5</div>
            <div className="text-sm text-slate-400">Valoración media</div>
          </div>
          <div className="bg-slate-800 rounded-lg p-6 text-center">
            <div className="text-3xl text-brand mb-2">24h</div>
            <div className="text-sm text-slate-400">Respuesta media</div>
          </div>
        </div>

        {/* Guarantee */}
        <div className="text-center max-w-2xl mx-auto bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-slate-700">
          <div className="inline-block bg-brand/10 rounded-full p-4 mb-4">
            <Star className="w-8 h-8 text-brand-light" />
          </div>
          <h3 className="text-2xl mb-4">Nuestra Garantía</h3>
          <p className="text-slate-300 mb-6">
            Si no recuperamos tu inmueble bajo las condiciones acordadas, devolvemos parte del coste según contrato
          </p>
          <Button 
            className="bg-brand hover:bg-brand-dark text-white px-8 py-6"
